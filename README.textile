...
you want to break after a block simply set the class attribute:
  ...
  <div><![CDATA[[<div class="break-after">...</div>]]></div>
  
or

  <div><![CDATA[[<div class="break-before">...</div>]]></div>
...
to the next page. Also:
  ...
  <div class="keep-with-previous caption">Some caption about figure 1</div>]]></div>
